...
## Introduction
This project is developed with Raspiberry Pi 4B, using [WiringPi]() to perform SPI interaction.

### Code Introduction
The file strucure includes:
- [nrf24l01p.c]() -> the basic functions to set up device
- [nrf_prx.c]() / [nrf_ptx.c]() -> the setup of Primary Receiver device and Primary Transimitter device
- [nrf_debug.c]() -> the basic functions to print out values in all registers, aiming to capture device status during debugging
- [nrf_security.c]() -> the basic functions of data security, currently no implementation


## Test and Product
The file [nrf_test]() is used to set up all product test details. 
